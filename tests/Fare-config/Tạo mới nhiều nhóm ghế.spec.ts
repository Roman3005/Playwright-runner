...
test('test', async ({ page }) => {
  ...
  await page.getByText('20 ghế Nam test trùng ghếHậu').click();
  ...
  await page.getByText('NƠI ĐẾN', { exact: true }).click();
   await page.getByRole('textbox', { name: 'Nhập giá' }).first().click();
  await page.getByRole('textbox', { name: 'Nhập giá' }).first().fill('10.0000');
  await page.getByRole('textbox', { name: 'Nhập giá' }).nth(1).click();
  await page.getByRole('textbox', { name: 'Nhập giá' }).nth(1).fill('20.0000');
